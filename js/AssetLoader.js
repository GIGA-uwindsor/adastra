 ...
 * Loaded items are automatically inserted into the AssetManager.
 */
...
AssetLoader.prototype = {
  ...
  loaded: function (item) {
    return this.__assetManager.has(item);
  },
  ...
  /*
   * Adds loaded font to AssetManager.
   */
  __webFontActive: function (fontFamily, fontDescription) {
    this.__assetManager.add(fontFamily, fontDescription);
